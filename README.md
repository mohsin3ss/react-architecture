...
* **Separate API server**: This project also has a server, having the purpose of serving only the pages for the website. Lhe logic of the application lies in a separate API server which is also opensource by us [**here**](https://github.com/mohsin3ss/node-js-architecture).
...
## Node.js Backend API Project: [**Goto Repository**](https://github.com/mohsin3ss/node-js-architecture)

## How to build and run this project
* Install the API server. [**Read Instructions Here**](https://github.com/mohsin3ss/node-js-architecture)
